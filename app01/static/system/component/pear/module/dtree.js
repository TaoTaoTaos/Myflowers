...
//			level: "level",			  //层级
    ...
    /**
     * @Desc: 将节点的disabledCancel
     * @Param: disabledIds： 需要设置Cancel禁用的节点id字符串集合（用,分割）/id数组
     */
    ...
    /**
     * @Desc: 将节点的disabledCancel
     * @Param: $div： JQuery对象，需要设置Cancel禁用的节点
     */
    ...
    /**
     * @Desc: 将节点的hideCancel
     * @Param: hideIds： 需要Cancel隐藏的节点id字符串集合（用,分割）/id数组
     */
    ...
    /**
     * @Desc: 设置节点为hide
     * @Param: $div： JQuery对象，需要设置Cancel隐藏的节点
     */
    ...
    DTree.prototype.removeCheckedNode = function(){
        ...
        if(len == 0){
            ...
            layer.confirm('Submit要删除选中节点？', {icon: 3, title:'删除选中节点'}, function(index1){
    ...
    DTree.prototype.toolbarListener = function(tool, $div) {
        ...
        switch (tool) {
            ...
            case defaultTool.delTool:
                layer.confirm('Submit要删除该'+_this.toolbarStyle.title+'？', {icon: 3, title:'删除'+_this.toolbarStyle.title}, function(index){
