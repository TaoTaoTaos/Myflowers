...
! function(i, r) {
	...
	s.formatArr = function(e) {
		...
		return s.year < h[0] && (s.year = h[0], o.hint(d.invalidDate)), s.year > h[1] && (s.year = h[1], o.hint(d.invalidDate)), o.firstDate || (o.firstDate = lay.extend({}, s)), y.setFullYear(s.year, s.month, 1), i = (y.getDay() + (7 - n.weekStart)) % 7, l = u.getEndDate(s.month || 12, s.year), r = u.getEndDate(s.month + 1, s.year), lay.each(c, function(e, t) {
		...
		}), lay(t[0]).attr("lay-ym", s.year + "-" + (s.month + 1)), lay(t[1]).attr("lay-ym", s.year + "-" + (s.month + 1)), "cn" === n.lang ? (lay(t[0]).attr("lay-type", "year").html(s.year + " \u5e74"), lay(t[1]).attr("lay-type", "month").html(s.month + 1 + " \u6708")) : (lay(t[0]).attr("lay-type", "month").html(d.month[s.month]), lay(t[1]).attr("lay-type", "year").html(s.year)), m && (n.range ? e && (o.listYM = [
			...
			[s.year, s.month + 1]
		], o.list(n.type, 0))), n.range && "init" === a && !e && o.calendar(o.endDate, 1), n.range || o.limit(lay(o.footer).find(E), null, 0, ["hours", "minutes", "seconds"]), o.setBtnStatus(), o
		...
		var i = this,
			...
			e = function(e) {
				...
				return t && (y[0] = e ? y[0] - 15 : y[0] + 15, i.list("year", n)), a && (e ? y[0]-- : y[0]++, i.list("month", n)), (t || a) && (lay.extend(r, {
					year: y[0]
				}), o && (r.year = y[0]), l.range || i.done(null, "change"), l.range || i.limit(lay(i.footer).find(E), {
					year: y[0]
				})), i.setBtnStatus(), t || a
			};
		return {
...
! function(p) {
	...
	var h, f, e, n = p.layui && layui.define,
		...
		i = (d.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], d.SHADE = "layui-layer-shade", d.MOVE = "layui-layer-move", t.pt.config = {
			...
			var t, i, n;
			e && (t = m.getChildFrame("html", e).outerHeight(), i = (e = h("#" + d[0] + e)).find(d[1]).outerHeight() || 0, n = e.find("." + d[6]).outerHeight() || 0, e.css({
				height: t + i + n
			}), e.find("iframe").css({
				height: t
			}))
			...
			e.attr("minLeft");
			a !== c.type[3] && a !== c.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - o - s <= 64 && (t.height = 64 + o + s)), e.css(t), s = e.find("." + d[6]).outerHeight() || 0, a === c.type[2] ? e.find("iframe").css({
		...
		o = {
			fixbar: function(t) {
				var e, i, n = "layui-fixbar",
					...
					l = ((t = u.extend({
						showHeight: 200
					}, t)).bar1 = !0 === t.bar1 ? "&#xe606;" : t.bar1, t.bar2 = !0 === t.bar2 ? "&#xe607;" : t.bar2, t.bgcolor = t.bgcolor ? "background-color:" + t.bgcolor : "", [t.bar1, t.bar2, "&#xe604;"]),
	...
	var m = layui.$,
		...
		F = (i.prototype.config = {
			...
			d.totalRow && (layui.each(e, function(e, i) {
				...
				var a, e = t.field || e,
					i = o && o[t.field],
					l = (a = t.totalRowText || "", n = "totalRowDecimals" in t ? t.totalRowDecimals : 2, n = parseFloat(s[e]).toFixed(n), (l = {
						LAY_COL: t
			...
			var s = this,
				...
				t = (s.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
					...
					}), s.setThisRowChecked(i), layui.event.call(this, C, "radio(" + d + ")", n.call(this, {
						checked: t
					}))
				...
				o = (s.layBody.on("change", "." + D, function() {
					...
					x.cache[s.key][e][a] = t, layui.event.call(this, C, "edit(" + d + ")", n.call(this, {
						value: t,
						field: a
					}))
				}).on("blur", "." + D, function() {
