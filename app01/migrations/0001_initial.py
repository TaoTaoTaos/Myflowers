    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, unique=True, verbose_name="发货方式"),
                ),
            ],
            options={
                "verbose_name": "发货方式",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "shipment_date",
                    models.DateField(blank=True, null=True, verbose_name="应发货日期"),
                ),
                (
                    "actual_shipment_date",
                    models.DateField(blank=True, null=True, verbose_name="实发货日期"),
                ),
                ...
                (
                    "tracking_number",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="运单号"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("remark", models.CharField(blank=True, default="无备注", max_length=200)),
                ("created_at", models.DateTimeField(editable=False)),
                ("updated_at", models.DateTimeField()),
                (
                    "created_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(blank=True, default="无描述", max_length=200),
                ),
                ("created_at", models.DateTimeField(editable=False)),
                ("updated_at", models.DateTimeField()),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_type",
                    models.CharField(
                        choices=[("price_one", "价格一"), ("price_two", "价格二")],
                        default="price_one",
                        max_length=10,
                        verbose_name="价格类型",
                    ),
