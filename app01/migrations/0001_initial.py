# Generated by Django 3.2.25 on 2024-07-18 05:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chineses_specifications', models.CharField(blank=True, default='无中文规格', max_length=200, null=True)),
                ('size', models.CharField(blank=True, default='', help_text='单位：cm', max_length=200)),
                ('weight', models.CharField(blank=True, default='', help_text='单位：g', max_length=200)),
                ('sale_spec_quantity', models.CharField(blank=True, default='', help_text='销售规格的数字', max_length=200)),
                ('sale_spec_unit', models.CharField(blank=True, choices=[('pcs', 'pcs'), ('g', 'g'), ('box', 'box'), ('kg', 'kg')], default='pcs', help_text='销售规格的单位', max_length=10, null=True)),
